...
using Soenneker.Lemlist.Runners.OpenApiClient.Utils.Abstract;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Lemlist:ClientGenerationUrl"] ?? "https://developer.lemlist.com/api-reference/openapi/v2.json";
        ...
        if (filePath == null)
            throw new InvalidOperationException("Lemlist OpenAPI document download failed.");
        ...
        await _kiotaUtil.Generate(fixedFilePath, "LemlistOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
